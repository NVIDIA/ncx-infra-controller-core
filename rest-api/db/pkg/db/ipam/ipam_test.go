...
func TestLockAndValidateParentIPBlockForAllocation(t *testing.T) {
	...
	for index, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			assert.Equal(t, tc.expectedStatus, stale.Status)
		})
	}
}

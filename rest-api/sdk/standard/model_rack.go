...
type Rack struct {
	...
	// Flow-derived operability phase aggregated across active Compute, NVSwitch, and PowerShelf components in the Rack. Unknown or missing component status wins, followed by Error, Initializing, Deleting, InUse, and Ready. A Rack with no supported active components is Unknown. The value does not depend on whether components are included in the response and is not the Core Rack lifecycle state.

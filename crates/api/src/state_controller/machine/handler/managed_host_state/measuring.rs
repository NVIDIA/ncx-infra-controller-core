...
use model::machine::{
    FailureDetails, FailureSource, MachineState, ManagedHostState, MeasuringState, StateMachineArea,
};
...
pub(crate) fn map_measuring_outcome_to_state_handler_outcome(
...
pub(crate) fn map_host_init_measuring_outcome_to_state_handler_outcome(
    measuring_outcome: &MeasuringOutcome,
    measuring_state: &MeasuringState,
) -> Result<StateHandlerOutcome<ManagedHostState>, StateHandlerError> {
    match measuring_outcome {

...
pub fn build_dpu_interfaces_vec() -> Vec<DpuServiceInterfaceTemplateDefinition> {
    let interfaces: Vec<DpuServiceInterfaceTemplateDefinition> = vec![
        ...
        DpuServiceInterfaceTemplateDefinition {
            ...
            vf_id: 0,
            chained_svc_if: Some(vec![
                ("doca-hbn".into(), "pf1hpf_if".into()),
                ("carbide-dhcp-server".into(), "d_pf1hpf_if".into()),
            ]),
        },
        DpuServiceInterfaceTemplateDefinition {
            name: "pf0vf0".into(),
        ...
        DpuServiceInterfaceTemplateDefinition {
            ...
            vf_id: 0,
            chained_svc_if: Some(vec![
                ("doca-hbn".into(), "pf1vf0_if".into()),
                ("carbide-dhcp-server".into(), "d_pf1vf0_if".into()),
            ]),
        },
        DpuServiceInterfaceTemplateDefinition {
            name: "pf1vf1".into(),
            ...
            vf_id: 1,
            chained_svc_if: Some(vec![
                ("doca-hbn".into(), "pf1vf1_if".into()),
                ("carbide-dhcp-server".into(), "d_pf1vf1_if".into()),
            ]),
        },
        DpuServiceInterfaceTemplateDefinition {
            name: "pf1vf2".into(),
            ...
            vf_id: 2,
            chained_svc_if: Some(vec![
                ("doca-hbn".into(), "pf1vf2_if".into()),
                ("carbide-dhcp-server".into(), "d_pf1vf2_if".into()),
            ]),
        },
        DpuServiceInterfaceTemplateDefinition {
            name: "pf1vf3".into(),
            ...
            vf_id: 3,
            chained_svc_if: Some(vec![
                ("doca-hbn".into(), "pf1vf3_if".into()),
                ("carbide-dhcp-server".into(), "d_pf1vf3_if".into()),
            ]),
        },
        DpuServiceInterfaceTemplateDefinition {
            name: "pf1vf4".into(),
            ...
            vf_id: 4,
            chained_svc_if: Some(vec![
                ("doca-hbn".into(), "pf1vf4_if".into()),
                ("carbide-dhcp-server".into(), "d_pf1vf4_if".into()),
            ]),
        },
        DpuServiceInterfaceTemplateDefinition {
            name: "pf1vf5".into(),
            ...
            vf_id: 5,
            chained_svc_if: Some(vec![
                ("doca-hbn".into(), "pf1vf5_if".into()),
                ("carbide-dhcp-server".into(), "d_pf1vf5_if".into()),
            ]),
        },
        DpuServiceInterfaceTemplateDefinition {
            name: "pf1vf6".into(),
            ...
            vf_id: 6,
            chained_svc_if: Some(vec![
                ("doca-hbn".into(), "pf1vf6_if".into()),
                ("carbide-dhcp-server".into(), "d_pf1vf6_if".into()),
            ]),
        },
        DpuServiceInterfaceTemplateDefinition {
            name: "pf1vf7".into(),
            ...
            vf_id: 7,
            chained_svc_if: Some(vec![
                ("doca-hbn".into(), "pf1vf7_if".into()),
                ("carbide-dhcp-server".into(), "d_pf1vf7_if".into()),
            ]),
        },
    ];
